...
public class MainActivity extends AppCompatActivity {
    ...
    public String createOrderSummary(int number1 , int number2, boolean addwhippedcream, boolean addchocolate, String name) {
        TextView ordersummary = (TextView) findViewById(R.id.price_text_view);
        String message = "Name : " + name +
                "\nAdd Whipped Cream ? " + addwhippedcream +
                "\nAdd chocolate ? " + addchocolate +
                "\nQuantity : " + number1 +
                "\nTotal : " + NumberFormat.getCurrencyInstance().format(number2) +
                "\nThank You!";
